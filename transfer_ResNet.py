...
# save fig
plt.savefig('ResNet50V2_without_fine_tune_loss_vs_epochs.png')
...
#
# save fig
plt.savefig('ResNet50V2_without_fine_tune_accuracy_vs_epochs.png')
...
sns.lineplot(data=temp,x="epoch", y="value", hue="metric",).set(xlabel='Epoch', ylabel='Loss', title='Cross-Entropy Loss vs Epochs for EfficientNetB0 \n(with fine_tune)')
# save fig
plt.savefig('ResNet50V2_with_fine_tune_loss_vs_epochs.png')
...
#
# save fig
plt.savefig('ResNet50V2_with_fine_tune_accuracy_vs_epochs.png')
